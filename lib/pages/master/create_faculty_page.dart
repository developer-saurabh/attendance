...
class _CreateFacultyPageState extends State<CreateFacultyPage> {
  ...
  final _phoneC = TextEditingController(); // ✅ ADDED PHONE CONTROLLER
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  /// ✅ PHONE FIELD ADDED
                  AppTextField(controller: _phoneC, label: 'Phone Number'),
                  const SizedBox(height: 16),
                    ...
                    onPressed: () async {
                      ...
                      try {
                        ...
                        await FirebaseFirestore.instance
                          ...
                          'email': _emailC.text.trim(),
                          'phone': _phoneC.text.trim(), // ✅ SAVED
                          'role': 'faculty',
                          'assignedSubjects': [], // ✅ helpful later
                        });
